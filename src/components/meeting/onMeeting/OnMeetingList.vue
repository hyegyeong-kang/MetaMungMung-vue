<template>
    <div data-viewname="DBandListSubRecommendBandsView" class="discoverBandList"><div class="mainWrap">
        <div class="sectionTitleArea gMab19">
            <h2 class="sectionTitle">이런 모임은 어때요</h2>
        </div>
            ...
            <li data-viewname="DDiscoverRecommendBandItemView" class="cCoverItem">
                <div class="bandUri">
                    ...
                    <div class="bandName">
                        ...
                        <a href="/discover/search/%EA%B7%B8%EB%A6%BC%EC%9F%81%EC%9D%B4" class="moreBandLink _tagLink" target="_blank"><strong>그림쟁이</strong> 모임 더보기</a>
